...
def main_app(name):        
        face_cascade = cv2.CascadeClassifier(rf"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\data\haarcascade_frontalface_default.xml")
        recognizer = cv2.face.LBPHFaceRecognizer_create()
        recognizer.read(rf"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\data\classifiers\{name}_classifier.xml")
