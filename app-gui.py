...
class MainUI(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        global names
        with open(r"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\faces.txt", "r") as f:
            x = f.read()
            z = x.rstrip().split(" ")
            for i in z:
                names.add(i)
        self.title_font = tkfont.Font(family='Helvetica', size=16, weight="bold")
        self.title("Face Recognization App")
    ...
    def on_closing(self):
        ...
        if messagebox.askokcancel("Quit", "Are you sure?"):
            global names
            f =  open(r"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\faces.txt", "a+")
            for i in names:
                    f.write(i+" ")
            self.destroy()
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            load = Image.open(r"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\home1.png")
            load = load.resize((400, 250), Image.ANTIALIAS)
            render = PhotoImage(file=r"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\home1.png")
            img = tk.Label(self, image=render)
            img.image = render
            img.grid(row=0, column=1, rowspan=4, sticky="nsew")
            label = tk.Label(self, text="        Home Page Menu        ", font=self.controller.title_font,fg="#263942")
            label.grid(row=0, sticky="ew")
            button1 = tk.Button(self, text="   Add  a Face  ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("Page1"))
            button2 = tk.Button(self, text="   Select a Face  ", fg="#ffffff", bg="#263942",command=lambda: self.controller.show_frame("Page2"))
            button3 = tk.Button(self, text="Quit/Exit", fg="#263942", bg="#ffffff", command=self.on_closing)
        ...
        def on_closing(self):
            if messagebox.askokcancel("Quit", "Are you sure you want to exit?"):
                global names
                with open(r"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\faces.txt", "w") as f:
                    for i in names:
                        f.write(i + " ")
...
class Page1(tk.Frame):
    ...
    def start_training(self):
        ...
        self.controller.frames["Page2"].refresh_names()
...
class Page3(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.capturebutton = tk.Button(self, text="Capture Your Image", fg="#ffffff", bg="#263942", command=self.capimg)
    ...
    def capimg(self):
        ...
        messagebox.showinfo("INSTRUCTIONS", "We will Capture around 200 pics of your Face.\nPlease keep your face on screen for a while.")
...
app = MainUI()
app.iconphoto(False, tk.PhotoImage(file=r"C:\Users\devan\OneDrive\Desktop\Sem 7\Minor Project\New folder\Face Recognition\icon.png"))
app.mainloop()
